#!/usr/bin/env python
# distilbert_train_gpu_batch32_fp32_grad_acc_with_mem.py
# Entrenamiento de DistilBERT en GPU usando FP32 y gradient accumulation.
...
# -------------------------------
config_name = "gpu_batch32_fp32_gradacc"
