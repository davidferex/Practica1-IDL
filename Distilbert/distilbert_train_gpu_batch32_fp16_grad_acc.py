#!/usr/bin/env python
# distilbert_train_gpu_batch32_fp16_grad_acc_with_mem.py
# Entrenamiento de DistilBERT en GPU usando FP16 y gradient accumulation.
# Batch real = 32, batch efectivo = 128.
...
# -------------------------------
config_name = "gpu_batch32_fp16_gradacc"
