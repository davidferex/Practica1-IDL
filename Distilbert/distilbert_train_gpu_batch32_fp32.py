#!/usr/bin/env python
# distilbert_train_gpu_batch32_fp32_with_mem_final.py
# Entrenamiento de DistilBERT en GPU usando FP32, batch de 32,
...
def trace_handler(p):
    ...
    print(output)
    trace_path = os.path.join(results_dir, f"trace_{p.step_num}_{config_name}.json")
...
accelerator = Accelerator(
    ...
    gradient_accumulation_steps=1  # sin grad acc
)
