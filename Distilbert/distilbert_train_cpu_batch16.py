#!/usr/bin/env python
# distilbert_train_cpu_batch16.py
# Entrenamiento de DistilBERT en CPU usando un batch de 16,
...
def trace_handler(p):
    ...
    print(output)
    trace_path = os.path.join(results_dir, f"trace_{p.step_num}_cpu_batch16.json")
    p.export_chrome_trace(trace_path)
    print(f"Trace guardada en: {trace_path}")

# -------------------------------
# Inicialización de Accelerate con profiling
# -------------------------------
