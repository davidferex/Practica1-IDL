#!/usr/bin/env python
# distilbert_train_cpu_batch32.py
# Entrenamiento de DistilBERT en CPU usando un batch de 32,
...
def trace_handler(p):
    ...
    print(output)
    trace_path = os.path.join(results_dir, f"trace_{p.step_num}_cpu_batch32.json")
