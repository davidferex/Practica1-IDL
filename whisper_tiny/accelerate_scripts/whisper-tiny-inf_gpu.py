# whisper-tiny-inf_gpu.py
# Inferencia de Whisper Tiny en GPU, FP32, batch=1.
# Línea base GPU. Incluye profiling CUDA y tracking de VRAM.
...
def main():
    ...
    batch_size = 1
    num_batches = 256  # 256 total samples, one at a time
