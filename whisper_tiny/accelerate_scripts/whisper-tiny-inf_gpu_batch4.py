# whisper-tiny-inf_gpu_batch4.py
# Inferencia en GPU, FP32, batch=4.
...
def main():
    ...
    print(f"Config: {config_name}  batch_size=16  device={device}", flush=True)
    ...
    batch_size = 4
    num_batches = 64  # 256 total samples
